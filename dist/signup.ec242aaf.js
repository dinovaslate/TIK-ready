...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"scripts/signup.js":[function(require,module,exports) {
...
//Facade pattern
var isValid = function isValid(elem, types, callback) {
...
var toggle1 = function toggle1() {
  var x = document.querySelector("#typepass1");
...
var myFunction = function myFunction(e) {
  isValid("#typepass1", {
    ...
    patternMismatch: "Must contain at least 1 uppercase and lowercase letter and also Special character",
    tooShort: "Password must be at least 8 characters long"
  });
  isValid("#first", {
    valueMissing: "Missing input of Fisrtname",
    patternMismatch: "Must contain at least one capital letter and must not contain number"
  });
  isValid("#last", {
  ...
  isValid("#year", {
    ...
    rangeUnderflow: "Please input valid year, below 1920 seems unreasonable",
...
var toggle2 = function toggle2(e) {
  ...
  e.currentTarget.innerText = "Use ".concat(email.classList.contains("d-none") ? "email" : "phone number", " ");
};

window.toggle2 = toggle2;

var insertAt = function insertAt(array, index) {
  for (var _len = arguments.length, elementsArray = new Array(_len > 2 ? _len - 2 : 0), _key = 2; _key < _len; _key++) {
    elementsArray[_key - 2] = arguments[_key];
  }

  array.splice.apply(array, [index, 0].concat(elementsArray));
};

var preventstring = function preventstring(evt) {
...
},{}]},{},["../node_modules/parcel-bundler/src/builtins/hmr-runtime.js","scripts/signup.js"], null)
//# sourceMappingURL=/signup.ec242aaf.js.map