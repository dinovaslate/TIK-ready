...
window.jumlahper1 = function jumlahper1() {
  var hargaElemen = document.getElementById("harga1").innerText.replace("$", "");
...
window.jumlahar = function jumlahar() {
  var jhar = parseFloat(document.getElementById("subtotal1").innerText.replace("$", "")) + parseFloat(document.getElementById("subtotal2").innerText.replace("$", "")) + parseFloat(document.getElementById("subtotal3").innerText.replace("$", ""));
